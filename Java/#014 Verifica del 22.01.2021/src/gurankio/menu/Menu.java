...
public class Menu {
    ...
    public Menu(Supplier<?> supplier) {
        ...
        ConsoleOutput.println("Per utilizzare il menu, scrivere il nome del metodo o attributo che si vuole chiamare o accedere.");
        ...
        while (!stack.isEmpty()) {
            ...
            if (next instanceof Window) {
                ...
                if (next != null) {
                    ...
                    ConsoleInput.read("Premere INVIO per continuare...", false);
            ...
            if (stack.size() > 0 && stack.peek() instanceof Integer) stack.pop();
        }
    }
}
