...
public class ConsoleInput {
    ...
    public static final HashMap<Class<?>, Supplier<?>> overrides = new HashMap<>();
    ...
    public static Object read(String prompt, Class<?> target) {
        ...
        // Override
        if (overrides.containsKey(target)) return overrides.get(target).get();
        ...
        Method valueOf = null;
        try {
            valueOf = target.getMethod("valueOf", String.class); // TODO: Check if static
